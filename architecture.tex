...
The symbolic nature of SymPy comes from its implementation of symbolic
variables, called symbols, which must be defined and assigned to Python
variables before they can be used. This is typically done through the
\texttt{symbols} function, which creates multiple symbols at once. For instance,
\begin{verbatim}
>>> x, y, z = symbols('x y z')
...
users will wish to simplify expressions containing terms like $\sqrt{x^2}$.
