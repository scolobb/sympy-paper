...
they provide a strong framework for build physics and engineering tools.
...
A.x + 5*sqrt(3)/2*A.y + 5/2*A.z
  ...
  \caption{
    ...
    Angles of magnitude $\pi$, $\frac{\pi}{2}$, and $\frac{\pi}{3}$ radians,
    respecitively whereas the $C$ frame is oriented with respect to the $B$
