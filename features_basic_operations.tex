...
In the old-style assumptions system prepositions are assigned to symbols
...
querying the assumptions is handled through class methods
...
and, as of the writing of this paper, 
they can accept only one parameter.
