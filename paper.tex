...
\texttt{(x.__mul__(y)).__add__(2)}. \texttt{x} and \texttt{y}, returned from
...
\texttt{__add__}, it is converted to the SymPy type \texttt{Integer(2)}. In
...
will perform floating point division and produce \texttt{0.5}\footnote{This is
  ...
  division and produce \texttt{0}, unless one uses \texttt{from __future__
